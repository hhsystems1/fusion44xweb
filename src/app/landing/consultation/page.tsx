...
const campaign = fusion44xLandingCampaigns.consultation;
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: `${siteConfig.url}/landing/consultation`,
  },
  openGraph: {
    title: `${campaign.seoTitle} | Fusion44x`,
    description: campaign.seoDescription,
    url: `${siteConfig.url}/landing/consultation`,
    type: "website",
  },
  twitter: {
...
export default function ConsultationLandingPage() {
  return (
    <Suspense fallback={<main className="min-h-screen bg-slate-950" />}>
      <Fusion44xLandingPage campaign={campaign} pagePath="/landing/consultation" />
    </Suspense>
  );
}
